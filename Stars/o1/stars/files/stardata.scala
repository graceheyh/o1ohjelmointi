...
def parseStarInfo(starAsString: String): Star =
  val tahti = starAsString.split(';')
  val koordinaatit = StarCoords(tahti(0).toDouble, tahti(1).toDouble)
  Star(tahti(3).toInt, koordinaatit, tahti(4).toDouble, tahti.lift(6))
